...
/*     */   }
/*     */   
/*     */   private class ColumnKeyIterator extends AbstractIterator<C> { final Map<C, V> seen;
/*     */     
/*     */     private ColumnKeyIterator() {
/* 659 */       this.seen = (Map<C, V>)StandardTable.this.factory.get();
/* 660 */       this.mapIterator = StandardTable.this.backingMap.values().iterator();
/* 661 */       this.entryIterator = Iterators.emptyIterator();
/*     */     } final Iterator<Map<C, V>> mapIterator; Iterator<Map.Entry<C, V>> entryIterator;
...
/* Location:              C:\Users\luisc\Documents\VM Folder\launcher.jar!\com\google\common\collect\StandardTable.class
